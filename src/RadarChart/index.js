...
export var RadarChart = function (props) {
    ...
    var hideDataPoints = props.hideDataPoints, _b = props.dataPointsColor, dataPointsColor = _b === void 0 ? 'black' : _b, _c = props.dataPointsRadius, dataPointsRadius = _c === void 0 ? 4 : _c, renderDataPoint = props.renderDataPoint, onPress = props.onPress;
    ...
    /******************************************************************************************/
    /******************************************************************************************/
    var renderDataPoints = function (dataToRender, dataConfig, dataSetIndex) {
        if (hideDataPoints)
            return null;
        return dataToRender.map(function (item, index) {
            var angle = index * angleStep + startAngle;
            var _a = polarToCartesian(angle, item), x = _a.x, y = _a.y;
            if (renderDataPoint) {
                return renderDataPoint(item, index, x, y);
            }
            return (_jsx(Circle, { cx: x, cy: y, r: dataPointsRadius, fill: dataPointsColor, onPress: function () { return onPress && onPress(item, index); } }, "data-point-".concat(dataSetIndex !== null && dataSetIndex !== void 0 ? dataSetIndex : '', "-").concat(index)));
        });
    };
    return (_jsx(View, { style: { justifyContent: 'center', alignItems: 'center' }, children: _jsxs(Svg, { height: chartSize, width: chartSize, children: [(polygonConfigArray === null || polygonConfigArray === void 0 ? void 0 : polygonConfigArray.length) ? (polygonConfigArray.map(function (polygonConfigItem, index) {
                    ...
                    return (_jsxs(Fragment, { children: [_jsx(AnimatedPolygon, { points: isAnimated ? animatedPolygonPoints : polygonPoints, fill: showGradient ? 'url(#polygon)' : fill, stroke: stroke, strokeWidth: strokeWidth, strokeDasharray: strokeDashArray, opacity: opacity }, "polygon-".concat(index)), renderDataPoints(dataSet[index], item, index)] }, "polygon-set-".concat(index)));
                })) : (_jsxs(Fragment, { children: [_jsx(AnimatedPolygon, { points: polygonIsAnimated ? animatedPaths : polygonPoints, fill: polygonShowGradient ? 'url(#polygon)' : polygonFill, stroke: polygonStroke, strokeWidth: polygonStrokeWidth, strokeDasharray: polygonStrokeDashArray, opacity: polygonOpacity }), renderDataPoints(data, {})] })), (dataSet === null || dataSet === void 0 ? void 0 : dataSet.length) && (dataLabelsArray === null || dataLabelsArray === void 0 ? void 0 : dataLabelsArray.length) ? (dataLabelsArray === null || dataLabelsArray === void 0 ? void 0 : dataLabelsArray.map(function (labels, index) {
